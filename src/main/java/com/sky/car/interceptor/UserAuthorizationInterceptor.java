...
public class UserAuthorizationInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        UserToken userToken = userTokenService.checkToken(token);
...
//            //服务器token验证
//            if (!checkToken(userSession,tokenId)) {
//                LOG.info(String.format("来自客户端[%s]-token【%s】已过期！",
//                        new Object[]{RequestUtil.getPosterIp(request), tokenId}));
//                result.setCode(104);
...
//            }
            ...
            request.setAttribute("token", userToken.getTokenId());
